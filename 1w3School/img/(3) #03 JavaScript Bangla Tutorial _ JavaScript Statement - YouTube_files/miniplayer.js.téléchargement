...
g.h.QF=function(){this.tooltip=new g.gP(this.player,this);g.H(this,this.tooltip);g.XK(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.xc=new g.eM(this.player);g.H(this,this.xc);this.Og=new g.W({G:"div",L:"ytp-miniplayer-scrim"});g.H(this,this.Og);this.Og.Ba(this.element);this.T(this.Og.element,"click",this.xB);var a=new g.W({G:"button",Fa:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Close"},U:[g.nI()]});g.H(this,a);a.Ba(this.Og.element);this.T(a.element,"click",this.Ti);
...
Fa:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Close"},U:[g.nI()]});g.H(this,a);a.Ba(this.mB.element);this.T(a.element,"click",this.Ti);a=new g.W({G:"button",Fa:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Close"},U:[g.tI()]});g.H(this,a);a.Ba(this.mB.element);this.T(a.element,"click",this.kY);this.T(this.player,"presentingplayerstatechange",this.Sc);this.T(this.player,"appresize",this.xb);this.T(this.player,"fullscreentoggled",this.xb);this.xb()};
